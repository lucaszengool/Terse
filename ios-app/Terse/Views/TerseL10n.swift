...
enum TL {
    ...
    private static let en: [String: String] = [
        ...
        "wallet.unlockThemes": "Use saved tokens to unlock keyboard styles",
        "wallet.myThemes": "My Keyboards",
        "wallet.themeShop": "Keyboard Shop",
        "wallet.unlock": "Unlock (₮100)",
        "wallet.unlockTitle": "Unlock Keyboard Style",
        "wallet.unlockHint": "Tap + to unlock new Terse keyboard colors with your saved tokens",
        "wallet.shopSubtitle": "Every 100 tokens saved = 1 new keyboard style",
        "wallet.done": "Done",
    ...
    private static let zhHans: [String: String] = [
        ...
        "wallet.tokens": "tokens",
        "wallet.unlockThemes": "用节省的 tokens 解锁键盘配色",
        "wallet.myThemes": "我的键盘",
        "wallet.themeShop": "键盘商店",
        "wallet.unlock": "解锁 (₮100)",
        "wallet.unlockTitle": "解锁键盘配色",
        "wallet.unlockHint": "点击 + 解锁更多 Terse 键盘配色方案",
        "wallet.shopSubtitle": "每节省 100 tokens = 解锁 1 个新键盘配色",
        "wallet.done": "完成",
        "wallet.cancel": "取消",
        "quota.left": "本周剩余",
        "quota.unlimited": "无限",
    ...
    private static let zhHant: [String: String] = [
        ...
        "wallet.tokens": "tokens",
        "wallet.myThemes": "我的鍵盤",
        "wallet.themeShop": "鍵盤商店",
        "wallet.unlock": "解鎖 (₮100)",
        "wallet.unlockHint": "點擊 + 解鎖更多 Terse 鍵盤配色方案",
        "wallet.shopSubtitle": "每節省 100 tokens = 解鎖 1 個新鍵盤配色",
        "wallet.done": "完成",
        "wallet.cancel": "取消",
        "quota.left": "本週剩餘",
        "settings.title": "設定",
    ...
    private static let ja: [String: String] = [
        ...
        "wallet.myThemes": "マイキーボード",
        "wallet.themeShop": "キーボードショップ",
        "wallet.done": "完了",
        "mode.soft": "ソフト",
        "mode.balanced": "バランス",
    ...
    private static let de: [String: String] = [
        ...
        "wallet.myThemes": "Meine Tastaturen",
        "wallet.done": "Fertig",
    ]
}

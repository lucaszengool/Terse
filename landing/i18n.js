(function(){
  ...
  'wp.con.label': 'Agent console',
  'wp.con.heading': 'Every running agent,<br><span class="gradient-text">one touch from the edge of your screen.</span>',
  'wp.con.subtitle': 'The console is a line on the left edge of your screen that opens into every agent you have running — drawn, like the wallpaper, entirely in particles. The panel and the hand in this page\'s background are a replay of it.',
  'wp.con.k1': 'Only what is running, sorted by who needs you',
  'wp.con.v1': 'Touch the edge and a rail of status beads bursts into cards — amber is waiting for you, green is working, blue is thinking, white just finished. Claude Code sessions, with Codex listed alongside.',
  'wp.con.k2': 'See the change, then allow it',
  'wp.con.v2': 'A card that needs approval shows the edit first: removed lines break apart in red, new ones gather in green. Allow or deny right on the card, and the command is pulled into the session\'s status dot.',
  'wp.con.k3': 'Who is burning your tokens',
  'wp.con.v3': 'A 5-hour fuel bar fed by particles from each busy session, a context watermark that collapses when a conversation is compacted, and on every card its branch, the +/− on the files it touched, and its PR.',
  'wp.con.k4': 'While you were away',
  'wp.con.v4': '"Away 23 min: 6 files changed, 14 commands run." New answers stay marked unread, and a session that keeps failing or repeating the same call is flagged.',
  'wp.con.k5': 'Gesture control (Pro)',
  'wp.con.v5': 'Your Mac\'s camera and Apple Vision track 21 joints of your hand, on-device. An open palm pushes the particles, a twisted fist changes their speed, a held palm freezes them — and Allow only ever answers a pinch.',
  ...
  'wp.v4': 'cinematic · aurora · starfall · ink · neon · vortex · bloom · zen. Each changes the palette, the choreography, and how the text gathers and breaks apart.',
    ...
    // Capability pillars (agent-butler section)
    'pillars.label': 'One butler, every agent',
    'pillars.heading': 'Not just a compressor.<br><span class="gradient-text">A butler for your AI agents.</span>',
    'pillars.subtitle': 'Terse handles the whole lifecycle of every AI coding agent you run — watching it, capping its spend, keeping its tools clean, and trimming every token. All on-device.',
    'pillars.optimize.title': 'Optimize',
    'pillars.optimize.desc': 'Compress every prompt 40–70% before it hits the API — 35+ on-device techniques, code always protected.',
    'pillars.monitor.title': 'Monitor',
    'pillars.monitor.desc': 'Live tokens, cost, cache efficiency, burn rate and context fill across 8 coding agents.',
    'pillars.budget.title': 'Budget breaker',
    'pillars.budget.desc': 'Set spend ceilings that pause or kill a runaway agent before its next API call.',
    'pillars.mcp.title': 'MCP manager',
    'pillars.mcp.desc': 'Discover every MCP server across your configs, risk-score each, toggle without editing JSON.',
    'pillars.doctor.title': 'Doctor',
    'pillars.doctor.desc': '25 waste scans — cache thrash, duplicate tool calls, redundant reads, context burn — with one-click fixes.',
    'pillars.team.title': 'Team',
    'pillars.team.desc': 'Share live agent sessions and team analytics — by developer, project, and tool.',
    ...
    // Get Started page
    'gs.welcome': 'Account created',
    'gs.title': 'Start Your Free Trial',
    'gs.subtitle': '30-day free trial — no charge until your trial ends.',
    'gs.subtitle2': 'Choose how you\'d like to pay after the trial:',
    'gs.recommended': 'RECOMMENDED',
    'gs.card.title': 'Bank Card',
    'gs.card.badge': '30-day free trial',
    'gs.card.desc': 'Visa, Mastercard, JCB, Amex — card required to activate trial',
    'gs.card.subdesc': 'Then $4.99 / month, cancel anytime',
    'gs.wechat.desc': 'Pay via WeChat QR code — $4.99 / month',
    'gs.wechat.subdesc': 'No trial period, billed immediately',
    'gs.alipay.desc': 'Pay via Alipay QR code — $4.99 / month',
    'gs.alipay.subdesc': 'No trial period, billed immediately',
    'gs.loading': 'Loading your account…',
    'gs.back': '← Back',
    'gs.signout': 'Sign out',
    'gs.footnote': 'By continuing you agree to our <a href="/terms-and-conditions.html" style="color:var(--t2);text-decoration:none">Terms</a> and <a href="/privacy.html" style="color:var(--t2);text-decoration:none">Privacy Policy</a>.',
    'gs.questions': 'Questions? <a href="mailto:support@terseai.org" style="color:var(--t2);text-decoration:none">support@terseai.org</a>',
  ...
  'wp.con.label': '智能体控制台',
  'wp.con.heading': '所有在跑的智能体，<br><span class="gradient-text">就在屏幕边缘一碰之处。</span>',
  'wp.con.subtitle': '控制台是屏幕左边缘的一条线，一碰就展开成你所有在跑的智能体——和壁纸一样，全部由粒子画成。本页背景里的面板和那只手，就是它的回放。',
  'wp.con.k1': '只放在跑的，按"需要你"排序',
  'wp.con.v1': '一碰边缘，状态珠轨炸开成卡片——琥珀在等你批准、绿在跑、蓝在思考、白刚完成。Claude Code 的会话，Codex 也一并列出。',
  'wp.con.k2': '先看改动，再允许',
  'wp.con.v2': '等你批准的卡片先把改动演给你看：删掉的行碎成红色，新增的行由绿色粒子聚成。就在卡片上允许或拒绝，命令被吸进这条会话的状态点。',
  'wp.con.k3': '谁在烧你的 token',
  'wp.con.v3': '5 小时燃料条，粒子从每个正在烧的会话流进去；上下文水位线，压缩时被吸成一点；每张卡还标着分支、它改过的文件的 +/−、PR。',
  'wp.con.k4': '你不在的时候',
  'wp.con.v4': '"你离开 23 分钟，它改了 6 个文件、跑了 14 条命令。"新回答保持未读标记；反复失败、或一直重复同一个调用的会话会被标出来。',
  'wp.con.k5': '手势控制（Pro）',
  'wp.con.v5': 'Mac 摄像头 + Apple Vision 在本机识别手的 21 个关节。张开手掌推开粒子，握拳拧手腕变速，张掌停住定格——"允许"只认捏合。',
  'wp.k4': '八种 Pro 风格',
  'wp.v4': 'cinematic · aurora · starfall · ink · neon · vortex · bloom · zen。每一种都会换掉配色、编舞，以及文字聚拢和碎裂的手法。',
    ...
    'pillars.label': '一位管家,统管所有智能体',
    'pillars.heading': '不止是压缩器。<br><span class="gradient-text">更是你 AI 智能体的管家。</span>',
    'pillars.subtitle': 'Terse 管理你运行的每一个 AI 编程智能体的完整生命周期——监控它、限制它的花费、保持工具整洁,并精简每一个 token。全部在本地完成。',
    'pillars.optimize.title': '优化',
    'pillars.optimize.desc': '在每条提示词发往 API 之前压缩 40–70%——35+ 种本地技术,代码始终受保护。',
    'pillars.monitor.title': '监控',
    'pillars.monitor.desc': '实时查看 8 个编程智能体的 token、成本、缓存效率、消耗速率与上下文占用。',
    'pillars.budget.title': '预算熔断',
    'pillars.budget.desc': '设置花费上限,在失控智能体发起下一次 API 调用前将其暂停或终止。',
    'pillars.mcp.title': 'MCP 管理',
    'pillars.mcp.desc': '发现你各处配置中的每一个 MCP 服务器,为每个评估风险,无需编辑 JSON 即可开关。',
    'pillars.doctor.title': '体检',
    'pillars.doctor.desc': '25 项浪费扫描——缓存抖动、重复工具调用、冗余读取、上下文消耗——一键修复。',
    'pillars.team.title': '团队',
    'pillars.team.desc': '共享实时智能体会话与团队分析——按开发者、项目和工具划分。',
    ...
    'gs.welcome': '账号已创建',
    'gs.title': '开始免费试用',
    'gs.subtitle': '30 天免费试用 — 试用期内不收取任何费用。',
    'gs.subtitle2': '选择试用结束后的付款方式：',
    'gs.recommended': '推荐',
    'gs.card.title': '银行卡',
    'gs.card.badge': '30 天免费试用',
    'gs.card.desc': 'Visa、Mastercard、JCB、Amex — 激活试用需绑定银行卡',
    'gs.card.subdesc': '试用后 $4.99 / 月，随时可取消',
    'gs.wechat.desc': '通过微信二维码付款 — $4.99 / 月',
    'gs.wechat.subdesc': '无试用期，立即扣费',
    'gs.alipay.desc': '通过支付宝二维码付款 — $4.99 / 月',
    'gs.alipay.subdesc': '无试用期，立即扣费',
    'gs.loading': '正在加载您的账户…',
    'gs.back': '← 返回',
    'gs.signout': '退出登录',
    'gs.footnote': '继续即表示您同意我们的 <a href="/terms-and-conditions.html" style="color:var(--t2);text-decoration:none">服务条款</a> 和 <a href="/privacy.html" style="color:var(--t2);text-decoration:none">隐私政策</a>。',
    'gs.questions': '有疑问？<a href="mailto:support@terseai.org" style="color:var(--t2);text-decoration:none">support@terseai.org</a>',
  ...
  'wp.v4': 'cinematic · aurora · starfall · ink · neon · vortex · bloom · zen。每一種都會換掉配色、編舞，以及文字聚攏和碎裂的手法。',
    ...
    'pillars.label': '一位管家,統管所有代理',
    'pillars.heading': '不只是壓縮器。<br><span class="gradient-text">更是你 AI 代理的管家。</span>',
    'pillars.subtitle': 'Terse 管理你執行的每一個 AI 編程代理的完整生命週期——監控它、限制它的花費、保持工具整潔,並精簡每一個 token。全部在本機完成。',
    'pillars.optimize.title': '最佳化',
    'pillars.optimize.desc': '在每條提示送往 API 之前壓縮 40–70%——35+ 種本機技術,程式碼始終受保護。',
    'pillars.monitor.title': '監控',
    'pillars.monitor.desc': '即時查看 8 個編程代理的 token、成本、快取效率、消耗速率與情境佔用。',
    'pillars.budget.title': '預算熔斷',
    'pillars.budget.desc': '設定花費上限,在失控代理發起下一次 API 呼叫前將其暫停或終止。',
    'pillars.mcp.title': 'MCP 管理',
    'pillars.mcp.desc': '發現你各處設定中的每一個 MCP 伺服器,為每個評估風險,無需編輯 JSON 即可切換。',
    'pillars.doctor.title': '健檢',
    'pillars.doctor.desc': '25 項浪費掃描——快取抖動、重複工具呼叫、冗餘讀取、情境消耗——一鍵修復。',
    'pillars.team.title': '團隊',
    'pillars.team.desc': '共享即時代理工作階段與團隊分析——依開發者、專案和工具劃分。',
    ...
    'gs.welcome': '帳號已建立',
    'gs.title': '開始免費試用',
    'gs.subtitle': '30 天免費試用 — 試用期內不收取任何費用。',
    'gs.subtitle2': '選擇試用結束後的付款方式：',
    'gs.recommended': '推薦',
    'gs.card.title': '信用卡',
    'gs.card.badge': '30 天免費試用',
    'gs.card.desc': 'Visa、Mastercard、JCB、Amex — 啟用試用需綁定信用卡',
    'gs.card.subdesc': '試用後 $4.99 / 月，隨時可取消',
    'gs.wechat.desc': '透過微信 QR 碼付款 — $4.99 / 月',
    'gs.wechat.subdesc': '無試用期，立即扣費',
    'gs.alipay.desc': '透過支付寶 QR 碼付款 — $4.99 / 月',
    'gs.alipay.subdesc': '無試用期，立即扣費',
    'gs.loading': '正在載入您的帳號…',
    'gs.back': '← 返回',
    'gs.signout': '登出',
    'gs.footnote': '繼續即表示您同意我們的 <a href="/terms-and-conditions.html" style="color:var(--t2);text-decoration:none">服務條款</a> 和 <a href="/privacy.html" style="color:var(--t2);text-decoration:none">隱私政策</a>。',
    'gs.questions': '有疑問？<a href="mailto:support@terseai.org" style="color:var(--t2);text-decoration:none">support@terseai.org</a>',
  ...
  'wp.v4': 'cinematic · aurora · starfall · ink · neon · vortex · bloom · zen。配色も、群れの振る舞いも、文字の集まり方と崩れ方も、それぞれ変わります。',
    ...
    'pillars.label': '執事は一人、エージェントはすべて',
    'pillars.heading': '単なる圧縮ツールではありません。<br><span class="gradient-text">あなたの AI エージェントの執事です。</span>',
    'pillars.subtitle': 'Terse は、あなたが動かすすべての AI コーディングエージェントのライフサイクル全体を管理します——監視し、支出を抑え、ツールを整え、あらゆるトークンを削減。すべてオンデバイスで。',
    'pillars.optimize.title': '最適化',
    'pillars.optimize.desc': 'すべてのプロンプトを API に届く前に 40–70% 圧縮——35+ のオンデバイス技術で、コードは常に保護されます。',
    'pillars.monitor.title': 'モニタリング',
    'pillars.monitor.desc': '8 つのコーディングエージェントにわたり、トークン・コスト・キャッシュ効率・消費速度・コンテキスト使用量をリアルタイムで。',
    'pillars.budget.title': '予算ブレーカー',
    'pillars.budget.desc': '支出の上限を設定し、暴走したエージェントを次の API 呼び出しの前に一時停止または停止します。',
    'pillars.mcp.title': 'MCP マネージャー',
    'pillars.mcp.desc': '設定全体からすべての MCP サーバーを検出し、それぞれをリスク評価。JSON を編集せずに切り替え。',
    'pillars.doctor.title': 'ドクター',
    'pillars.doctor.desc': '25 項目の無駄スキャン——キャッシュスラッシング、重複ツール呼び出し、冗長な読み込み、コンテキスト消費——をワンクリックで修正。',
    'pillars.team.title': 'チーム',
    'pillars.team.desc': 'ライブのエージェントセッションとチーム分析を共有——開発者・プロジェクト・ツール別に。',
  ...
  'wp.v4': 'cinematic · aurora · starfall · ink · neon · vortex · bloom · zen. 각각 색조와 움직임, 글자가 모이고 부서지는 방식이 달라집니다.',
    ...
    'pillars.label': '집사 하나로 모든 에이전트를',
    'pillars.heading': '단순한 압축기가 아닙니다.<br><span class="gradient-text">당신의 AI 에이전트를 위한 집사입니다.</span>',
    'pillars.subtitle': 'Terse는 당신이 실행하는 모든 AI 코딩 에이전트의 전체 수명 주기를 관리합니다——모니터링하고, 지출을 제한하고, 도구를 깔끔하게 유지하고, 모든 토큰을 줄입니다. 모두 온디바이스에서.',
    'pillars.optimize.title': '최적화',
    'pillars.optimize.desc': '모든 프롬프트를 API에 도달하기 전에 40–70% 압축——35+ 온디바이스 기법, 코드는 항상 보호됩니다.',
    'pillars.monitor.title': '모니터링',
    'pillars.monitor.desc': '8개 코딩 에이전트에 걸쳐 토큰, 비용, 캐시 효율, 소진 속도, 컨텍스트 사용량을 실시간으로.',
    'pillars.budget.title': '예산 차단기',
    'pillars.budget.desc': '지출 상한을 설정해 폭주하는 에이전트를 다음 API 호출 전에 일시 중지하거나 종료합니다.',
    'pillars.mcp.title': 'MCP 관리자',
    'pillars.mcp.desc': '여러 설정에 흩어진 모든 MCP 서버를 찾아내고 각각 위험도를 평가하며 JSON 편집 없이 켜고 끕니다.',
    'pillars.doctor.title': '닥터',
    'pillars.doctor.desc': '25가지 낭비 스캔——캐시 스래싱, 중복 도구 호출, 불필요한 읽기, 컨텍스트 소모——을 원클릭으로 해결.',
    'pillars.team.title': '팀',
    'pillars.team.desc': '실시간 에이전트 세션과 팀 분석을 공유——개발자, 프로젝트, 도구별로.',
    'hero.exchange': '토큰 매매',
    'hero.cloudCta': 'Terse Cloud',
  ...
  'wp.v4': 'cinematic · aurora · starfall · ink · neon · vortex · bloom · zen. Cada uno cambia la paleta, la coreografía y cómo el texto se reúne y se rompe.',
    ...
    'pillars.label': 'Un mayordomo para todos sus agentes',
    'pillars.heading': 'No es solo un compresor.<br><span class="gradient-text">Un mayordomo para sus agentes de IA.</span>',
    'pillars.subtitle': 'Terse gestiona todo el ciclo de vida de cada agente de programación con IA que usted ejecuta: lo vigila, limita su gasto, mantiene sus herramientas ordenadas y recorta cada token. Todo en el dispositivo.',
    'pillars.optimize.title': 'Optimizar',
    'pillars.optimize.desc': 'Comprima cada prompt un 40–70% antes de que llegue a la API: 35+ técnicas en el dispositivo, con el código siempre protegido.',
    'pillars.monitor.title': 'Monitorizar',
    'pillars.monitor.desc': 'Tokens, coste, eficiencia de caché, ritmo de consumo y llenado de contexto en tiempo real en 8 agentes de programación.',
    'pillars.budget.title': 'Cortacircuitos de gasto',
    'pillars.budget.desc': 'Establezca límites de gasto que pausen o detengan a un agente descontrolado antes de su próxima llamada a la API.',
    'pillars.mcp.title': 'Gestor de MCP',
    'pillars.mcp.desc': 'Descubra cada servidor MCP en sus configuraciones, evalúe el riesgo de cada uno y actívelos sin editar JSON.',
    'pillars.doctor.title': 'Doctor',
    'pillars.doctor.desc': '25 análisis de desperdicio: saturación de caché, llamadas de herramientas duplicadas, lecturas redundantes y consumo de contexto, con soluciones en un clic.',
    'pillars.team.title': 'Equipo',
    'pillars.team.desc': 'Comparta sesiones de agentes en vivo y analíticas de equipo: por desarrollador, proyecto y herramienta.',
  ...
  'wp.v4': 'cinematic · aurora · starfall · ink · neon · vortex · bloom · zen. Chacun change la palette, la chorégraphie, et la façon dont le texte se rassemble et se disperse.',
    ...
    'pillars.label': 'Un majordome, tous vos agents',
    'pillars.heading': 'Pas seulement un compresseur.<br><span class="gradient-text">Un majordome pour vos agents IA.</span>',
    'pillars.subtitle': 'Terse gère tout le cycle de vie de chaque agent de code IA que vous exécutez : il le surveille, plafonne ses dépenses, garde ses outils propres et réduit chaque token. Le tout sur l’appareil.',
    'pillars.optimize.title': 'Optimiser',
    'pillars.optimize.desc': 'Compressez chaque prompt de 40–70 % avant qu’il n’atteigne l’API — 35+ techniques sur l’appareil, code toujours protégé.',
    'pillars.monitor.title': 'Surveiller',
    'pillars.monitor.desc': 'Tokens, coût, efficacité du cache, rythme de consommation et remplissage du contexte en temps réel sur 8 agents de code.',
    'pillars.budget.title': 'Coupe-circuit de budget',
    'pillars.budget.desc': 'Définissez des plafonds de dépense qui suspendent ou arrêtent un agent hors de contrôle avant son prochain appel API.',
    'pillars.mcp.title': 'Gestionnaire MCP',
    'pillars.mcp.desc': 'Repérez chaque serveur MCP dans vos configurations, évaluez le risque de chacun et activez-les sans éditer de JSON.',
    'pillars.doctor.title': 'Docteur',
    'pillars.doctor.desc': '25 analyses de gaspillage — saturation du cache, appels d’outils en double, lectures redondantes, consommation de contexte — avec corrections en un clic.',
    'pillars.team.title': 'Équipe',
    'pillars.team.desc': 'Partagez des sessions d’agents en direct et des analyses d’équipe — par développeur, projet et outil.',
  ...
  'wp.v4': 'cinematic · aurora · starfall · ink · neon · vortex · bloom · zen. Jeder ändert Palette, Choreografie und die Art, wie der Text sich sammelt und zerfällt.',
    ...
    'pillars.label': 'Ein Butler für alle Agenten',
    'pillars.heading': 'Nicht nur ein Kompressor.<br><span class="gradient-text">Ein Butler für Ihre KI-Agenten.</span>',
    'pillars.subtitle': 'Terse verwaltet den gesamten Lebenszyklus jedes KI-Coding-Agenten, den Sie ausführen — überwacht ihn, deckelt seine Ausgaben, hält seine Tools sauber und kürzt jeden Token. Alles auf dem Gerät.',
    'pillars.optimize.title': 'Optimieren',
    'pillars.optimize.desc': 'Komprimieren Sie jeden Prompt um 40–70 %, bevor er die API erreicht — 35+ Techniken auf dem Gerät, Code stets geschützt.',
    'pillars.monitor.title': 'Überwachen',
    'pillars.monitor.desc': 'Tokens, Kosten, Cache-Effizienz, Verbrauchsrate und Kontextauslastung in Echtzeit über 8 Coding-Agenten hinweg.',
    'pillars.budget.title': 'Budget-Schutzschalter',
    'pillars.budget.desc': 'Legen Sie Ausgabenobergrenzen fest, die einen außer Kontrolle geratenen Agenten vor seinem nächsten API-Aufruf pausieren oder stoppen.',
    'pillars.mcp.title': 'MCP-Manager',
    'pillars.mcp.desc': 'Entdecken Sie jeden MCP-Server in Ihren Konfigurationen, bewerten Sie jeweils das Risiko und schalten Sie sie um, ohne JSON zu bearbeiten.',
    'pillars.doctor.title': 'Doktor',
    'pillars.doctor.desc': '25 Verschwendungs-Scans — Cache-Thrashing, doppelte Tool-Aufrufe, redundante Lesevorgänge, Kontextverbrauch — mit Ein-Klick-Lösungen.',
    'pillars.team.title': 'Team',
    'pillars.team.desc': 'Teilen Sie Live-Agenten-Sitzungen und Team-Analysen — nach Entwickler, Projekt und Tool.',
  ...
  'wp.v4': 'cinematic · aurora · starfall · ink · neon · vortex · bloom · zen. كل واحد يغير الألوان والحركة وطريقة تجمع النص وتفتته.',
    ...
    'pillars.label': 'خادم واحد، لكل الوكلاء',
    'pillars.heading': 'ليس مجرد أداة ضغط.<br><span class="gradient-text">بل خادم لوكلاء الذكاء الاصطناعي لديك.</span>',
    'pillars.subtitle': 'يدير Terse دورة الحياة الكاملة لكل وكيل برمجة بالذكاء الاصطناعي تشغّله — يراقبه، ويحدّ من إنفاقه، ويبقي أدواته نظيفة، ويقلّص كل رمز. كل ذلك على الجهاز.',
    'pillars.optimize.title': 'التحسين',
    'pillars.optimize.desc': 'اضغط كل موجّه بنسبة 40–70% قبل وصوله إلى الـ API — أكثر من 35+ تقنية على الجهاز، مع حماية الشيفرة دائمًا.',
    'pillars.monitor.title': 'المراقبة',
    'pillars.monitor.desc': 'الرموز والتكلفة وكفاءة التخزين المؤقت ومعدل الاستهلاك وامتلاء السياق في الوقت الفعلي عبر 8 وكلاء برمجة.',
    'pillars.budget.title': 'قاطع الميزانية',
    'pillars.budget.desc': 'حدّد سقوفًا للإنفاق توقف أو تنهي وكيلًا خارجًا عن السيطرة قبل استدعائه التالي للـ API.',
    'pillars.mcp.title': 'مدير MCP',
    'pillars.mcp.desc': 'اكتشف كل خادم MCP عبر إعداداتك، وقيّم مخاطر كلٍّ منها، وبدّل الحالة دون تحرير JSON.',
    'pillars.doctor.title': 'الطبيب',
    'pillars.doctor.desc': '25 فحصًا للهدر — تذبذب التخزين المؤقت، واستدعاءات الأدوات المكررة، والقراءات الزائدة، واستهلاك السياق — مع إصلاحات بنقرة واحدة.',
    'pillars.team.title': 'الفريق',
    'pillars.team.desc': 'شارك جلسات الوكلاء المباشرة وتحليلات الفريق — حسب المطوّر والمشروع والأداة.',
  ...
  'wp.v4': 'cinematic · aurora · starfall · ink · neon · vortex · bloom · zen. Ognuno cambia palette, coreografia e il modo in cui il testo si raccoglie e si sgretola.',
    ...
    'pillars.label': 'Un maggiordomo, ogni agente',
    'pillars.heading': 'Non solo un compressore.<br><span class="gradient-text">Un maggiordomo per i tuoi agenti IA.</span>',
    'pillars.subtitle': 'Terse gestisce l’intero ciclo di vita di ogni agente di programmazione IA che esegui: lo controlla, ne limita la spesa, mantiene puliti i suoi strumenti e riduce ogni token. Tutto sul dispositivo.',
    'pillars.optimize.title': 'Ottimizza',
    'pillars.optimize.desc': 'Comprimi ogni prompt del 40–70% prima che raggiunga l’API: 35+ tecniche sul dispositivo, con il codice sempre protetto.',
    'pillars.monitor.title': 'Monitora',
    'pillars.monitor.desc': 'Token, costo, efficienza della cache, ritmo di consumo e riempimento del contesto in tempo reale su 8 agenti di programmazione.',
    'pillars.budget.title': 'Interruttore di spesa',
    'pillars.budget.desc': 'Imposta tetti di spesa che mettono in pausa o arrestano un agente fuori controllo prima della sua prossima chiamata API.',
    'pillars.mcp.title': 'Gestore MCP',
    'pillars.mcp.desc': 'Scopri ogni server MCP nelle tue configurazioni, valuta il rischio di ciascuno e attivali senza modificare il JSON.',
    'pillars.doctor.title': 'Doctor',
    'pillars.doctor.desc': '25 scansioni degli sprechi — thrashing della cache, chiamate di strumenti duplicate, letture ridondanti, consumo di contesto — con correzioni in un clic.',
    'pillars.team.title': 'Team',
    'pillars.team.desc': 'Condividi sessioni di agenti dal vivo e analisi del team — per sviluppatore, progetto e strumento.',
  ...
  'wp.v4': 'cinematic · aurora · starfall · ink · neon · vortex · bloom · zen. Cada um muda a paleta, a coreografia e o modo como o texto se junta e se parte.',
    ...
    'pillars.label': 'Um mordomo, todos os agentes',
    'pillars.heading': 'Não é apenas um compressor.<br><span class="gradient-text">Um mordomo para os seus agentes de IA.</span>',
    'pillars.subtitle': 'O Terse cuida de todo o ciclo de vida de cada agente de programação com IA que você executa — monitorando, limitando os gastos, mantendo as ferramentas organizadas e reduzindo cada token. Tudo no dispositivo.',
    'pillars.optimize.title': 'Otimizar',
    'pillars.optimize.desc': 'Comprima cada prompt em 40–70% antes de chegar à API — 35+ técnicas no dispositivo, com o código sempre protegido.',
    'pillars.monitor.title': 'Monitorar',
    'pillars.monitor.desc': 'Tokens, custo, eficiência de cache, ritmo de consumo e preenchimento de contexto em tempo real em 8 agentes de programação.',
    'pillars.budget.title': 'Disjuntor de gastos',
    'pillars.budget.desc': 'Defina limites de gasto que pausam ou encerram um agente descontrolado antes da próxima chamada à API.',
    'pillars.mcp.title': 'Gerenciador de MCP',
    'pillars.mcp.desc': 'Descubra cada servidor MCP nas suas configurações, avalie o risco de cada um e ative-os sem editar JSON.',
    'pillars.doctor.title': 'Doctor',
    'pillars.doctor.desc': '25 verificações de desperdício — thrashing de cache, chamadas de ferramentas duplicadas, leituras redundantes, consumo de contexto — com correções em um clique.',
    'pillars.team.title': 'Equipe',
    'pillars.team.desc': 'Compartilhe sessões de agentes ao vivo e análises de equipe — por desenvolvedor, projeto e ferramenta.',
    'hero.exchange': 'Comprar / Vender Tokens',
    'hero.cloudCta': 'Terse Cloud',
  ...
  var TT = {}, tLoading = {}, tpl = [], tplReady = false, mo = null, TVER = '7';
